                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <?php foreach ($data['applicant'] as $applicant) : ?>
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo $applicant->FirstName . "@gmail.com" ?></td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500"><?php echo $applicant->Place ?></td>
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <a href="<?= URLROOT ?>/applicant/edit/<?php echo $applicant->Id ?>" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">, Lindsay Walton</span></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                <!-- More people... -->
